    ...
    public static final class RequestBuilder<R> {
        ...
        public HttpRequest<R> build() {
            if (provider != null) {
                ...
                String tokenId = provider.getTokenId();
                if (tokenId == null)
                    tokenId = provider.getTokenId(request);
                if (tokenId != null && provider.getAuthHeaderName() != null)
                    request.getHeaders().put(provider.getAuthHeaderName(), tokenId);
